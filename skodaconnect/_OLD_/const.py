...
ERROR_CODES = {"11": "Charger not connected"}
...
API_POSITION = (
    "fs-car/bs/cf/v1/{BRAND}/{COUNTRY}/vehicles/{vin}/position"  # Position data
)
...
API_REFRESH = (
    "fs-car/bs/vsr/v1/{BRAND}/{COUNTRY}/vehicles/{vin}/requests"  # Force data refresh
)
